...
public class UserTracker extends Component
{
	...
	public OutArg<ScriptNode> scriptNode;
    ...
    public boolean drawSkeleton = true;
    public boolean printID = true;
    ...
    public final String SAMPLE_XML_FILE = "C:/Program Files (x86)/OpenNI/Data/SamplesConfig.xml";
    public UserTracker()
    {
